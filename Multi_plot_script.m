...
hold on
xlabel('log10(time2) (s)','fontsize',font_size,'Interpreter','latex');
ylabel('$\epsilon_1$','fontsize',font_size,'Interpreter','latex');
set(gca,'XMinorGrid','off','GridLineStyle','-','FontSize',line_size)
grid on
...
hold on
xlabel('Time2 (s)','fontsize',font_size,'Interpreter','latex');
...
figure
subplot(3,1,1)
plot(t,torque_t(1,:),'Linewidth',line_width); % torque_t_x vs time
hold on
xlabel('Time (s)','fontsize',font_size,'Interpreter','latex');
...
subplot(3,1,2)
plot(t,torque_t(2,:),'Linewidth',line_width); %torque_t_y vs time
hold on
xlabel('Time (s)','fontsize',font_size,'Interpreter','latex');
...
subplot(3,1,3)
plot(t,torque_t(3,:),'Linewidth',line_width); %torque_t_z vs time
hold on
xlabel('Time (s)','fontsize',font_size,'Interpreter','latex');
...
%dipole moment vs time

figure
subplot(3,1,1)
plot(t,mag_moment(1,:),'Linewidth',line_width); %mx vs time
hold on
xlabel('Time (s)','fontsize',font_size,'Interpreter','latex');
...
subplot(3,1,2)
plot(t,mag_moment(2,:),'Linewidth',line_width); %my vs time
hold on
xlabel('Time (s)','fontsize',font_size,'Interpreter','latex');
...
subplot(3,1,3)
plot(t,mag_moment(3,:),'Linewidth',line_width); %mz vs time
hold on
xlabel('Time (s)','fontsize',font_size,'Interpreter','latex');
